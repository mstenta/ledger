...
namespace Drupal\ledger_account_entry\Plugin\Field\FieldType;
...
/**
 * Defines the 'ledger_account_entry' field type.
 *
 * @FieldType(
 *   id = "ledger_account_entry",
 *   label = @Translation("Account entry"),
 ...
 */
class LedgerAccountEntryItem extends FieldItemBase {
